...
> you depend on the current behaviour, pin the package version. The client-side
...
> **Note:** String operators (`contains`, `equals`, `startsWith`, `endsWith`, `not`) are case-insensitive. The `is` operator is case-sensitive, matching MUI's default behavior. Because filtering is reimplemented in R, edge cases (locale, accents) can differ from MUI's own client-side filter.
